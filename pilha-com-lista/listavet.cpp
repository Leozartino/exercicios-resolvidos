...
void inserir_no_fim(ListaVet* lista, int item) {
	inserir(lista, item, obter_tamanho(lista));
}
...
int remover_do_fim(ListaVet* lista) {
	return remover(lista, obter_tamanho(lista) - 1);
}
...
int obter_do_fim(ListaVet* li) {
	return obter(li, obter_tamanho(li) - 1);
}
