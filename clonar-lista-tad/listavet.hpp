...
/** 
 * \brief Cria e retorna uma cópia idêntica (clone) da lista passada por parâmetro.
 *  
 * Exemplo de uso:
 * \code {.cpp}
 * #include<cstdlib>
 ...
 * 
 * \param *li representa um ponteiro para a lista a ser clonada.
 * 
 * \return O endereço de memória da lista clonada.
 * 
